...
{
    /// <summary>
    ///     Wireframe are a 3D line primitive whose thickness
    ...
    /// </summary>
    public class ScreenLines : ModelVisual3D
    {
        public ScreenLines()
        {
        ...
        {
            ((ScreenLines)sender).SetColor((Color)args.NewValue);
        }
        ...
        {
            ((ScreenLines)sender).GeometryDirty();
        }
        ...
        {
            if ((Points == null || _mesh == null) || (Points.Count == 0 && _mesh.Positions.Count == 0))
            {
                return;
            }
        ...
        private bool UpdateTransforms()
        {
            ...
            bool success;
            Matrix3D visualToScreen;

            try
            {
                 visualToScreen = MathUtils.TryTransformTo2DAncestor(this, out viewport, out success);
            }
